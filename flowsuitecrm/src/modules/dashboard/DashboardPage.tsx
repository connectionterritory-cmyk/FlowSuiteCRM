...
export function DashboardPage() {
  ...
  return (
    <div className="page-stack">
      ...
      {showDeferredSections ? <AgendaHoy /> : <DeferredSectionPlaceholder label={t('common.loading')} />}
      {showDeferredSections ? (
        <>
          <DashboardConversionSection
            ...
            scopePendingLabel={scopePendingLabel}
          />
          <DashboardChartsSection scopePendingLabel={scopePendingLabel} />
        </>
      ) : (
        <>
          <DeferredSectionPlaceholder label={t('common.loading')} />
...
function DashboardChartsSection({ scopePendingLabel }: { scopePendingLabel: string }) {
  const { t } = useTranslation()
  const {
    salesSeries,
    pipelineSeries,
...
function DeferredSectionPlaceholder({ label }: { label: string }) {
  return (
    <div className="card" style={{ minHeight: '12rem', display: 'grid', placeItems: 'center' }}>
