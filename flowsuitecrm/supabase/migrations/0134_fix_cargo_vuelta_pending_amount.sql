-- ============================================================
-- 0134: fix cargo vuelta pending amount creation
--
-- La tabla legacy cargo_vuelta_cases exige monto_total NOT NULL.
-- Cuando la UI abre un caso sin "Monto cargo de vuelta", el caso debe
-- quedar pendiente, no fallar por monto_total null.
-- ============================================================
