-- ============================================================
-- 0133: fn_get_cargo_vuelta_campaign_targets
--
-- Objetivo:
--   RPC read-only para seleccionar casos Cargo de Vuelta / DFP elegibles
--   para la campana automatica MOCK de n8n.
--
-- Workflow n8n:
--   jRJAhjnBcXBjBwFE
--   Cargo de Vuelta / DFP - Cobranza Automatica MOCK
--
-- Reglas:
...
--   - No registra pagos.
--   - Usa outbox_messages como anti-duplicado y fuente de intentos.
--
-- ROLLBACK:
--   drop function if exists public.fn_get_cargo_vuelta_campaign_targets(uuid,date,int,int,int,boolean);
-- ============================================================
