-- ============================================================
-- 0135: en_proceso_legal en cargo_vuelta_cases
--
-- Bandera operativa para marcar casos que escalaron a proceso legal.
-- ROLLBACK: alter table public.cargo_vuelta_cases drop column if exists en_proceso_legal;
-- ============================================================
