...
\restrict SWqXEkM9PNKuyn2JTygwayUxTEd8a6gzOZ176YGFuQcw78jX3AhPW19EUXRWXLm
...
--
-- Name: cliente_estado_morosidad; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: embajador_nivel; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: lead_estado_pipeline; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: oportunidad_etapa; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: programa_4en14_estado; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: programa_4en14_referido_estado; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: usuario_rol; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: venta_tipo_movimiento; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: ci_create_leads_for_activation(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.ci_create_leads_for_activation() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
declare
  _owner_id uuid;
...
--
-- Name: fn_proteger_roles(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.fn_proteger_roles() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
BEGIN
  IF (OLD.rol IS DISTINCT FROM NEW.rol) AND NOT public.is_admin() THEN
    RAISE EXCEPTION 'Operacion denegada: Solo un Administrador puede modificar los roles del sistema.';
  END IF;
  RETURN NEW;
END;
$$;
...
--
-- Name: is_distribuidor(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.is_distribuidor() RETURNS boolean
    LANGUAGE sql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
  SELECT EXISTS (SELECT 1 FROM public.usuarios WHERE id = auth.uid() AND rol = 'distribuidor');
$$;


--
-- Name: is_distribuidor_of(uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.is_distribuidor_of(vendor_id uuid) RETURNS boolean
    LANGUAGE sql STABLE
    AS $$
  select exists (
    select 1 from public.usuarios u
    where u.id = vendor_id and u.distribuidor_padre_id = auth.uid()
  );
$$;


--
-- Name: is_vendedor(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.is_vendedor() RETURNS boolean
    LANGUAGE sql STABLE
    AS $$
  SELECT exists (
    SELECT 1 FROM public.usuarios
    WHERE id = auth.uid() AND rol IN ('vendedor','telemercadeo')
  );
$$;
...
--
-- Name: ci_activaciones; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.ci_activaciones (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
...
--
-- Name: ci_referidos; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.ci_referidos (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
...
--
-- Name: componentes_equipo; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: embajador_programas; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.embajador_programas (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
...
--
-- Name: embajadores; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: equipos_instalados; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.equipos_instalados (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    cliente_id uuid,
    producto_id uuid,
    vendedor_id uuid,
...
--
-- Name: COLUMN leads.whatsapp_mensaje_enviado_at; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: periodos_programa; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.periodos_programa (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    nombre text,
...
--
-- Name: programa_4en14; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.programa_4en14 (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
...
--
-- Name: programa_4en14_referidos; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.programa_4en14_referidos (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    programa_id uuid,
    nombre text,
    telefono text,
...
--
-- Name: servicio_componentes; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.servicio_componentes (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    servicio_id uuid,
...
--
-- Name: ci_activaciones ci_activaciones_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ci_referidos ci_referidos_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: clientes clientes_numero_cuenta_financiera_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: componentes_equipo componentes_equipo_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: embajador_programas embajador_programas_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: embajador_programas embajador_programas_unique; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: embajadores embajadores_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: equipos_instalados equipos_instalados_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: periodos_programa periodos_programa_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: programa_4en14 programa_4en14_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: programa_4en14_referidos programa_4en14_referidos_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: servicio_componentes servicio_componentes_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: usuarios usuarios_codigo_distribuidor_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.usuarios
    ADD CONSTRAINT usuarios_codigo_distribuidor_key UNIQUE (codigo_distribuidor);


--
-- Name: usuarios usuarios_codigo_vendedor_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ventas ventas_numero_nota_pedido_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: clientes_distribuidor_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: clientes_fecha_nacimiento_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: clientes_vendedor_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: componentes_equipo_activo_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: componentes_equipo_proximo_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: embajador_programas_periodo_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: embajador_programas_periodo_nivel_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: embajadores_fecha_nacimiento_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: embajadores_owner_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: equipos_instalados_cliente_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: leads_estado_pipeline_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: leads_telefono_unique; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: oportunidades_etapa_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: oportunidades_owner_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: periodos_programa_one_active_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: programa_4en14_estado_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: programa_4en14_referidos_estado_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: programa_4en14_vendedor_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: servicios_cliente_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: servicios_vendedor_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: usuarios_distribuidor_padre_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: usuarios_email_unique; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: ventas_fecha_venta_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: ventas_vendedor_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: ci_activaciones ci_activaciones_create_leads; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER ci_activaciones_create_leads AFTER INSERT OR UPDATE OF whatsapp_mensaje_enviado_at ON public.ci_activaciones FOR EACH ROW EXECUTE FUNCTION public.ci_create_leads_for_activation();
...
--
-- Name: componentes_equipo set_updated_at_componentes_equipo; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER set_updated_at_componentes_equipo BEFORE UPDATE ON public.componentes_equipo FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();


--
-- Name: embajador_programas set_updated_at_embajador_programas; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER set_updated_at_embajador_programas BEFORE UPDATE ON public.embajador_programas FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();


--
-- Name: embajadores set_updated_at_embajadores; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER set_updated_at_embajadores BEFORE UPDATE ON public.embajadores FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();


--
-- Name: equipos_instalados set_updated_at_equipos_instalados; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER set_updated_at_equipos_instalados BEFORE UPDATE ON public.equipos_instalados FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();
...
--
-- Name: oportunidades set_updated_at_oportunidades; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER set_updated_at_oportunidades BEFORE UPDATE ON public.oportunidades FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();


--
-- Name: periodos_programa set_updated_at_periodos_programa; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER set_updated_at_periodos_programa BEFORE UPDATE ON public.periodos_programa FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();
...
--
-- Name: programa_4en14 set_updated_at_programa_4en14; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER set_updated_at_programa_4en14 BEFORE UPDATE ON public.programa_4en14 FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();


--
-- Name: programa_4en14_referidos set_updated_at_programa_4en14_referidos; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER set_updated_at_programa_4en14_referidos BEFORE UPDATE ON public.programa_4en14_referidos FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();


--
-- Name: programas set_updated_at_programas; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER set_updated_at_programas BEFORE UPDATE ON public.programas FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();


--
-- Name: servicio_componentes set_updated_at_servicio_componentes; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER set_updated_at_servicio_componentes BEFORE UPDATE ON public.servicio_componentes FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();


--
-- Name: servicios set_updated_at_servicios; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: usuarios set_updated_at_usuarios; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: ventas set_updated_at_ventas; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER set_updated_at_ventas BEFORE UPDATE ON public.ventas FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();


--
-- Name: usuarios tr_usuarios_proteger_roles; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER tr_usuarios_proteger_roles BEFORE UPDATE ON public.usuarios FOR EACH ROW EXECUTE FUNCTION public.fn_proteger_roles();
...
--
-- Name: ci_activaciones ci_activaciones_cliente_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ci_activaciones ci_activaciones_lead_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ci_activaciones ci_activaciones_owner_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ci_activaciones ci_activaciones_programa_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ci_activaciones ci_activaciones_regalo_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ci_activaciones ci_activaciones_representante_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ci_referidos ci_referidos_activacion_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ci_referidos ci_referidos_lead_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ci_referidos ci_referidos_owner_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: clientes clientes_distribuidor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: clientes clientes_vendedor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: componentes_equipo componentes_equipo_equipo_instalado_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: embajador_programas embajador_programas_embajador_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: embajador_programas embajador_programas_owner_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: embajador_programas embajador_programas_periodo_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: embajadores embajadores_owner_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: equipos_instalados equipos_instalados_cliente_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: equipos_instalados equipos_instalados_producto_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: equipos_instalados equipos_instalados_vendedor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: leads leads_embajador_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: leads leads_programa_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: oportunidades oportunidades_lead_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: oportunidades oportunidades_owner_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: programa_4en14_referidos programa_4en14_referidos_lead_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: programa_4en14_referidos programa_4en14_referidos_programa_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: programa_4en14 programa_4en14_regalo_producto_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: programa_4en14 programa_4en14_vendedor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: servicio_componentes servicio_componentes_componente_equipo_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: servicio_componentes servicio_componentes_servicio_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: servicios servicios_cliente_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: servicios servicios_equipo_instalado_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: servicios servicios_vendedor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: servicios servicios_venta_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: usuarios usuarios_distribuidor_padre_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: usuarios admin_all; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: clientes clientes_distribuidor_read; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY clientes_distribuidor_read ON public.clientes FOR SELECT TO authenticated USING ((public.is_distribuidor() AND ((distribuidor_id = auth.uid()) OR public.is_distribuidor_of(vendedor_id))));


--
-- Name: clientes clientes_vendedor_all; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY clientes_vendedor_all ON public.clientes TO authenticated USING ((vendedor_id = auth.uid())) WITH CHECK ((vendedor_id = auth.uid()));


--
-- Name: componentes_equipo; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.componentes_equipo ENABLE ROW LEVEL SECURITY;

--
-- Name: componentes_equipo componentes_equipo_admin_all; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY componentes_equipo_admin_all ON public.componentes_equipo TO authenticated USING (public.is_admin()) WITH CHECK (public.is_admin());


--
-- Name: componentes_equipo componentes_equipo_distribuidor_read; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: componentes_equipo componentes_equipo_vendedor_all; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: usuarios dist_team_insert; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: usuarios dist_team_select; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: usuarios dist_team_update; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: embajador_programas; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.embajador_programas ENABLE ROW LEVEL SECURITY;

--
-- Name: embajador_programas embajador_programas_admin_all; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: embajador_programas embajador_programas_distribuidor_read; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: embajador_programas embajador_programas_vendedor_all; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: embajadores; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.embajadores ENABLE ROW LEVEL SECURITY;

--
-- Name: embajadores embajadores_admin_all; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: embajadores embajadores_distribuidor_read; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: embajadores embajadores_vendedor_all; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: equipos_instalados; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.equipos_instalados ENABLE ROW LEVEL SECURITY;

--
-- Name: equipos_instalados equipos_instalados_admin_all; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY equipos_instalados_admin_all ON public.equipos_instalados TO authenticated USING (public.is_admin()) WITH CHECK (public.is_admin());


--
-- Name: equipos_instalados equipos_instalados_distribuidor_read; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: equipos_instalados equipos_instalados_vendedor_all; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: leads leads_distribuidor_read; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY leads_distribuidor_read ON public.leads FOR SELECT TO authenticated USING ((public.is_distribuidor() AND public.is_distribuidor_of(owner_id)));


--
-- Name: leads leads_vendedor_all; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY leads_vendedor_all ON public.leads TO authenticated USING ((owner_id = auth.uid())) WITH CHECK ((owner_id = auth.uid()));
...
CREATE POLICY oportunidades_admin_all ON public.oportunidades TO authenticated USING (public.is_admin()) WITH CHECK (public.is_admin());


--
-- Name: oportunidades oportunidades_distribuidor_read; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY oportunidades_distribuidor_read ON public.oportunidades FOR SELECT TO authenticated USING ((public.is_distribuidor() AND public.is_distribuidor_of(owner_id)));


--
-- Name: oportunidades oportunidades_vendedor_all; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY oportunidades_vendedor_all ON public.oportunidades TO authenticated USING ((owner_id = auth.uid())) WITH CHECK ((owner_id = auth.uid()));


--
-- Name: periodos_programa; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.periodos_programa ENABLE ROW LEVEL SECURITY;

--
-- Name: periodos_programa periodos_programa_admin_all; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: periodos_programa periodos_programa_read_authenticated; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: productos productos_read_authenticated; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: programa_4en14; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.programa_4en14 ENABLE ROW LEVEL SECURITY;

--
-- Name: programa_4en14 programa_4en14_admin_all; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: programa_4en14 programa_4en14_distribuidor_read; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: programa_4en14_referidos; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.programa_4en14_referidos ENABLE ROW LEVEL SECURITY;

--
-- Name: programa_4en14_referidos programa_4en14_referidos_admin_all; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: programa_4en14_referidos programa_4en14_referidos_distribuidor_read; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: programa_4en14_referidos programa_4en14_referidos_vendedor_all; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: programa_4en14 programa_4en14_vendedor_all; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: programas programas_admin_all; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: programas programas_read_authenticated; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: servicio_componentes; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.servicio_componentes ENABLE ROW LEVEL SECURITY;

--
-- Name: servicio_componentes servicio_componentes_admin_all; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: servicio_componentes servicio_componentes_distribuidor_read; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: servicio_componentes servicio_componentes_vendedor_all; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: servicios servicios_admin_all; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: servicios servicios_distribuidor_read; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY servicios_distribuidor_read ON public.servicios FOR SELECT TO authenticated USING ((public.is_distribuidor() AND ((EXISTS ( SELECT 1
   FROM public.clientes c
  WHERE ((c.id = servicios.cliente_id) AND ((c.distribuidor_id = auth.uid()) OR public.is_distribuidor_of(c.vendedor_id))))) OR public.is_distribuidor_of(vendedor_id))));


--
-- Name: servicios servicios_vendedor_all; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY servicios_vendedor_all ON public.servicios TO authenticated USING (((vendedor_id = auth.uid()) OR (EXISTS ( SELECT 1
   FROM public.clientes c
  WHERE ((c.id = servicios.cliente_id) AND (c.vendedor_id = auth.uid())))))) WITH CHECK ((vendedor_id = auth.uid()));


--
-- Name: usuarios user_self_select; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: usuarios user_self_update; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: usuarios usuarios_distribuidor_read; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: ventas ventas_admin_all; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY ventas_admin_all ON public.ventas TO authenticated USING (public.is_admin()) WITH CHECK (public.is_admin());


--
-- Name: ventas ventas_distribuidor_read; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY ventas_distribuidor_read ON public.ventas FOR SELECT TO authenticated USING ((public.is_distribuidor() AND public.is_distribuidor_of(vendedor_id)));


--
-- Name: ventas ventas_vendedor_all; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY ventas_vendedor_all ON public.ventas TO authenticated USING ((vendedor_id = auth.uid())) WITH CHECK ((vendedor_id = auth.uid()));
...
\unrestrict SWqXEkM9PNKuyn2JTygwayUxTEd8a6gzOZ176YGFuQcw78jX3AhPW19EUXRWXLm
